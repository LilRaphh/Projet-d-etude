...
def build_prompt(outfit):
    ...
    return (
        f'Realistic full-body fashion studio photograph of a male mannequin wearing {garments_text}. '
        f'Outfit purpose: {occasion_text}. Season: {season_text}. '
        'Straight front view, mannequin standing naturally, centered composition, '
        'entire body visible from head to toe, hands visible, feet visible, '
        ...
        f'{footwear_text}, sharp focus, ultra detailed, realistic proportions.'
    )
